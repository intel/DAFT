...
The offset can be calculated by opening the image file with fdisk, printing the partition table and then multiplying the starting position by sector size

\begin{lstlisting}

fdisk bone-debian-8.2-tester-2gb-armhf-2015-11-12-2gb.img 
