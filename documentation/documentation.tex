...
\begin{lstlisting}
*SSH authorized key
*nfs mount into /etc/fstab. May require nfsvers=4 as one of the parameters

192.168.30.1:/home/tester /mnt/img_data_nfs nfs rsize=8192,wsize=8192,timeo=14,intr,nolock,auto,nfsvers=4

*Recipes may need to be added to the supported-recipes list 
* Connman may need to be installed separately
* openssh may need to be installed
* Create /mnt/target_root on the device
\end{lstlisting}
\end{document}
